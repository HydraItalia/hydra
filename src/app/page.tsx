  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-3xl w-full space-y-8 text-center">
        ...
        <div className="space-y-6 bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
            <div className="p-4 border rounded-lg">
              <h3 className="font-semibold text-blue-600 mb-2">For Restaurants</h3>
            ...
            <div className="p-4 border rounded-lg">
              <h3 className="font-semibold text-blue-600 mb-2">For Vendors</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="p-4 border rounded-lg">
              <h3 className="font-semibold text-blue-600 mb-2">For Admins</h3>
              <p className="text-sm text-gray-600">
