...
- [ ] SubOrder table exists with all required fields
- [ ] Enums (SubOrderStatus, PaymentStatus) exist
- [ ] Foreign keys and indexes are in place

✅ **Order Creation:**

- [ ] Single-vendor orders create 1 SubOrder
- [ ] Multi-vendor orders create N SubOrders (one per vendor)
- [ ] SubOrder numbers follow pattern: `HYD-YYYYMMDD-XXXX-V##`
- [ ] Order.totalCents = SUM(SubOrder.subTotalCents)

✅ **Status Management:**

- [ ] SubOrder state transitions are validated
- [ ] Parent Order status derives from SubOrder statuses
- [ ] Timestamp fields (confirmedAt, readyAt) are set automatically
- [ ] Updates are atomic (both or neither)

✅ **Delivery System:**

- [ ] Deliveries link to SubOrders (not Orders)
- [ ] Multiple SubOrders can have different drivers
- [ ] routeSequence = 0 is preserved (not converted to null)

✅ **Vendor Isolation:**

- [ ] Vendors see only their own SubOrders
- [ ] Vendor can't access other vendors' SubOrders
- [ ] Each vendor manages their own workflow independently
